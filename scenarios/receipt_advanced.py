...
STEPS = [
    ...
    FieldStep(
        ...
        question="Укажите процентную ставку (например: 10% годовых) или введите 'пропустить':",
    ...
    FieldStep(
        ...
        question="Укажите период начисления процентов (например: 'со дня получения до дня возврата') или 'пропустить':",
    ...
    FieldStep(
        name="ask_penalty",
        question="Укажите штраф/пени за просрочку (например: 0,1% от суммы за каждый день) или 'пропустить':",
        data_key="penalty",
        field_type=FieldType.TEXT,
        optional=True,
    ),
    FieldStep(
        ...
        question="Укажите порядок возврата (например: 'наличными', 'переводом на карту') или 'пропустить':",
